...
For this part of the final you have some data and you need to fit a prediction model. I have some held out test data that I will evaluate your prediction model with. You will upload two things into Canvas for this part (1) this .html file and (2) The final_mod.rds file that you will save below that contains the final model that you  fit (that I will run on my test data).
